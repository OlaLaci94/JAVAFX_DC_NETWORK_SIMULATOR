...
public class DiscoSimulation extends Movement {
    ...
    public DiscoSimulation(Button backSimulatorBtn, Button pauseSimulatorBtn, Button playSimulatorBtn, StackPane stackPane, ImageView messageImgViw, ImageView thetaImgViw,
                           ImageView snakeImgViw, ImageView elephantImgViw, TextFlow textFlow, HBox signatureVector, TextArea signatureVector1,
...
//        part1();
    ...
    public void animationPart1(){
        ...
        fadeTransition(500.0, snakeImgViw, 1.0,0.0,1,false);
        ...
        scaleTransition.setOnFinished(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Text text = new Text("A variant of the hiding function generator provides each participant with two hiding functions for each other participant " +
                        "in the session. ");
                fadeTransition(3500.0, snakeImgViw, 0.0,1.0,1,false);
